...
const EXPERIENCE = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "<strong>Programmable Bit Permutation Engine</strong> — Designed a configurable 1024-bit programmable permutation engine at a 300 MHz clock, resolving setup/hold timing violations, for the <code>xc7z030ffg676-3</code> (Zynq-7000 series) FPGA."
    ]
  }
];
...
const PROJECTS = [
  ...
  },
  {
    id: "bit-permuter",
    pin: "21",
    title: "Programmable Bit Permutation Engine",
    cats: ["fpga"],
    featured: true,
    role: "Personal Project · RTL design & verification",
    short: "A configurable 1024-bit programmable permutation engine for Zynq-7000, with BRAM-backed runtime reconfiguration and a shadow-buffered config path.",
    body: `<p>Designed a configurable N-bit (1024 default) programmable permutation engine for the <code>xc7z030ffg676-3</code> (Zynq&#8209;7000) FPGA, supporting runtime reconfiguration of bit ordering through a streamed, ready/valid configuration interface backed by a BRAM index table.</p>
    <p>A shadow shift register stages incoming configuration indices before committing them to BRAM, allowing the permutation table to be safely reprogrammed without corrupting an in-flight mapping. The input vector is split into 32-bit chunks for addressable bit selection, and the permutation mux reassembles the output across 9 BRAM-backed pages through a fully pipelined datapath &mdash; sustaining 1 permutation per 1&nbsp;&micro;s at 300&nbsp;MHz with identity mapping as the default, unprogrammed state.</p>
    <div class="proj-diagram">
      <img src="top_level_diagram.png" alt="bit_permuter top-level I/O block diagram" loading="lazy">
      <p class="proj-diagram-caption">Top-level bit_permuter I/O &mdash; config stream, data stream, and permuted output</p>
    </div>
    <div class="proj-diagram">
      <img src="internal_microarch_diagram.png" alt="bit_permuter internal microarchitecture diagram" loading="lazy">
      <p class="proj-diagram-caption">Shadow shift register &rarr; BRAM &rarr; index generation &rarr; perm mux &rarr; output packing, sequenced across 9 BRAM page reads</p>
    </div>
    <div class="proj-diagram">
      <img src="block_ram_diagram.png" alt="Block_RAM module diagram" loading="lazy">
      <p class="proj-diagram-caption">Parameterized Block_RAM wrapper backing the permutation index table</p>
    </div>
    <p>Verified with a self-checking testbench covering 10 test cases in Vivado xsim, reporting a pass/fail summary with expected-vs-actual mismatches on failure.</p>`,
    link: "https://github.com/Nameer-Iqbal-Ansari/Programmable-Bit-Permutation-Engine",
    tech: ["SystemVerilog", "BRAM", "Zynq-7000", "Vivado", "Ready/Valid Streaming", "Pipelining"]
  }
];
...
const REGMAP = [
  ...
  { addr: "0x1C", name: "FPGA Boards",         fields: ["AWS EC2 F1","VU19P","Arty A7","xc7z030ffg676-3 (Zynq-7000 series)","Tang Nano 9k"] }
];
